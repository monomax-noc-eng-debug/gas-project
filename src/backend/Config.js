...
// ฟังก์ชันสำหรับกด Run เพื่อดู Log โดยเฉพาะ
function debugTicketCalculation() {
  // 1. ใส่วันที่ที่คุณต้องการทดสอบ (Format: yyyy-MM-dd)
  const TEST_DATE = "2026-02-10";

  console.log(`🚀 START DEBUGGING for date: ${TEST_DATE}`);

  // 2. เรียกฟังก์ชันคำนวณ
  const resultJson = getTicketDetails(TEST_DATE);
